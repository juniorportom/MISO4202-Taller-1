...
public class CeffectivePackageImpl extends EPackageImpl implements CeffectivePackage {
	 ...
	 */
	@Override
	public EAttribute getGrupoSeguridad_ZonaDisponibilidad() {
		return (EAttribute)grupoSeguridadEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(grupoSeguridadEClass, GRUPO_SEGURIDAD__ZONA_DISPONIBILIDAD);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGrupoSeguridad_ZonaDisponibilidad(), ecorePackage.getEString(), "zonaDisponibilidad", null, 0, 1, GrupoSeguridad.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
