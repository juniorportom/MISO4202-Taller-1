...
public class CeffectiveFactoryImpl extends EFactoryImpl implements CeffectiveFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case CeffectivePackage.DIRECCION_REGLA:
				return createDireccionReglaFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case CeffectivePackage.DIRECCION_REGLA:
				return convertDireccionReglaToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public DireccionRegla createDireccionReglaFromString(EDataType eDataType, String initialValue) {
		DireccionRegla result = DireccionRegla.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertDireccionReglaToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
